...
<script src="animatedLogo.js"></script>
<script>
...
<body onload="init();" style="margin:0px;">
	...
	<div id="para_container" style="width:500px; height:55px; margin: auto;">
    ...
    <input type="submit" value="ENLIGHTEN" class="button" name="submit" border="0" alt="Submit"style="width: 205px; height: 30px; margin:0 auto;" />
